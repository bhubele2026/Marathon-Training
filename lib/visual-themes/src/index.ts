...
export const PALETTES: Record<string, PaletteDefinition> = {
  ...
  studio: {
    ...
    name: "Studio",
    number: "01",
    tagline: "Charcoal neutrals + one muted teal. Calm, professional, focused.",
    light: {
      ...
      sidebarPrimary: "174 60% 38%",
      sidebarPrimaryForeground: "0 0% 100%",
      sidebarAccent: "220 12% 20%",
      sidebarAccentForeground: "0 0% 98%",
      sidebarRing: "174 60% 38%",
      popover: "0 0% 100%",
      popoverForeground: "220 18% 14%",
      ...
      brandOrange: "174 62% 36%",
      brandPurple: "174 62% 36%",
      chart1: "174 62% 38%",
      chart2: "220 10% 38%",
      chart3: "220 9% 52%",
      chart4: "220 8% 66%",
    ...
    dark: {
      ...
      sidebarPrimary: "174 60% 45%",
      sidebarPrimaryForeground: "220 30% 8%",
      sidebarAccent: "220 10% 15%",
      sidebarAccentForeground: "210 16% 94%",
      sidebarRing: "174 60% 45%",
      popover: "220 12% 12%",
      ...
      input: "220 10% 16%",
      ring: "174 60% 45%",
      brandOrange: "174 60% 45%",
      brandPurple: "174 60% 45%",
      chart1: "174 60% 48%",
      chart2: "220 10% 70%",
      chart3: "220 9% 56%",
      chart4: "220 8% 42%",
