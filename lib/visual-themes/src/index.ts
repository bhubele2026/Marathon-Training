...
export const PALETTES: Record<string, PaletteDefinition> = {
  ...
  studio: {
    ...
    light: {
      ...
      brandOrange: "222 84% 50%",
      brandPurple: "222 84% 50%",
      chart1: "222 84% 52%",
      chart2: "220 10% 38%",
      chart3: "220 9% 52%",
      chart4: "220 8% 66%",
    ...
    dark: {
      ...
      input: "220 10% 16%",
      ring: "222 88% 60%",
      brandOrange: "222 88% 60%",
      brandPurple: "222 88% 60%",
      chart1: "222 90% 64%",
      chart2: "220 10% 70%",
      chart3: "220 9% 56%",
      chart4: "220 8% 42%",
