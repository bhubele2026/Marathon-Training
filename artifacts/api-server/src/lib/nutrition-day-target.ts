...
async function aiAdjustment(
  ...
  const system = [
    ...
    "a 1:1 calorie refund. This is forward-looking FUEL guidance for today's",
    "training — the rationale frames what to eat, never a verdict on a",
    "half-finished day; never imply the runner is behind or failing. Reply with",
